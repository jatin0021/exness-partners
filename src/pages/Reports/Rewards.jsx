    ...
    <div className="flex flex-col w-full h-full bg-[#F7F9FA] px-6 py-6">
      <div className="w-full max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col gap-1 mb-8">
          <h1 className="text-[32px] font-bold text-[#1d1d1d]">Reward history</h1>
          <p className="text-[14px] text-[#6b7280]">The report is updated once in 24 hours.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-white rounded-[4px] p-2 flex flex-col items-center justify-center shadow-sm border-none h-[80px]">
             <div className="flex items-baseline text-[#1d1d1d]">
                <span className="text-[24px] font-bold">0.00</span>
             </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-4">
                ...
                <button className="text-[#3b82f6] font-medium hover:underline">Payment date</button>
                </div>
        ...
        <div className="w-full border-b border-[#e5e7eb] pb-3 mb-8">
            <div className="grid grid-cols-12 gap-x-4 text-[13px] font-bold text-[#1d1d1d]">
                ...
                <div className="col-span-1 flex items-center justify-end gap-1 cursor-pointer group hover:text-gray-600">
                   <ArrowUp size={14} className="text-[#d1d5db] group-hover:text-[#9ca3af]" strokeWidth={2.5} />
                   Profit
                </div>
            </div>
